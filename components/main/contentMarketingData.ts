...
export const contentMarketingData: ContentMarketingData[] = [
  {
  ...
  },
  {
    ...
    image: "/imagetrail2.jpeg",
    color: "linear-gradient(135deg, #4facfe 0%, #00f2fe 100%)"
  },
  {
    title: "Performance Analytics",
    description: "Track, measure, and optimize your content performance with advanced analytics. We provide actionable insights that help you refine your strategy and achieve better ROI on your content marketing efforts.",
    image: "/imagetrail3.jpeg",
