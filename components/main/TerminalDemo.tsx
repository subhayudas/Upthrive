...
const TerminalDemo = () => {
  ...
  return (
    <div className="max-w-5xl mx-auto px-4 sm:px-6 py-10 sm:py-16 md:py-20">
      <div className="font-bold text-2xl sm:text-3xl md:text-4xl lg:text-5xl pb-3 sm:pb-5 text-center bg-clip-text text-transparent bg-gradient-to-r from-gray-400 to-gray-300 bg-opacity-50 mb-5 sm:mb-10 font-playfair">
